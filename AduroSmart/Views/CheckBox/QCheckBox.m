...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"btn_unchoise.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"btn_choise.png"] forState:UIControlStateSelected];
