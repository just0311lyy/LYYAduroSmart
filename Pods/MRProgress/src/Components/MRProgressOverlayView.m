 ...
 *    cancelBtn
 */
    UIButton *cancelView = [UIButton new];
    [cancelView setImage:[UIImage imageNamed:@"close mark"] forState:UIControlStateNormal];
//    [cancelView setFrame:CGRectMake(dialogView.frame.size.width +26, 1, 25, 25)];
    [cancelView addTarget:self action:@selector(closeButtonAction:) forControlEvents:UIControlEventTouchUpInside];
    [dialogView addSubview:cancelView];
    self.cancelBtn = cancelView;
// -------------------
...
- (void)manualLayoutSubviews {
    ...
    // ** ---------
//    const CGFloat dialogMinWidth = bounds.size.width/2;;
    // ** ---------
    ...
    // ** ----------
    [self.cancelBtn setFrame:CGRectMake(self.dialogView.frame.size.width-27, 1, 25, 25)];
    // ** ----------
...
-(void)closeButtonAction:(UIButton *)sender{
    [self.delegate closeButton:sender];
}
